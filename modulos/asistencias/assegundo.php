...
$sql = "SELECT a.id, a.nombres, a.apellidos, g.nombre_grado AS grado, asistencia.fecha, IFNULL(asistencia.estado, 0) AS estado
        ...
        WHERE g.id = '3' AND asistencia.fecha = :fecha_busqueda
...
<div class="container-fluid">
    <div class="page-header">
        <h1 class="text-titles"><i class="zmdi zmdi-book zmdi-hc-fw"></i> Asistencias: <small>2DO GRADO</small></h1>
    </div>
</div>
<div class="container-fluid">
    <div class="row">
                ...
                <div class="tab-pane fade active in" id="list">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <a href="segundo/pdfS.php?fecha=<?php echo $fecha_busqueda; ?>" target="_blank" class="btn btn-success" style="border: 2px solid #808080; background-color: #808080; color: #fff;">
