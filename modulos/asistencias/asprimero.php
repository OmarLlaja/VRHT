...
$sql = "SELECT a.id, a.nombres, a.apellidos, g.nombre_grado AS grado, asistencia.fecha, IFNULL(asistencia.estado, 0) AS estado
        ...
        WHERE g.id = '1' AND asistencia.fecha = :fecha_busqueda
...
<div class="container-fluid">
    <div class="page-header">
        <h1 class="text-titles"><i class="zmdi zmdi-book zmdi-hc-fw"></i> Asistencias: <small>1ER GRADO</small></h1>
    </div>
</div>
<div class="container-fluid">
    <div class="row">
                ...
                <div class="tab-pane fade active in" id="list">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <a href="primero/pdfP.php?fecha=<?php echo $fecha_busqueda; ?>" target="_blank" class="btn btn-success" style="border: 2px solid #808080; background-color: #808080; color: #fff;">
                                ...
                                <tbody>
                                    <?php foreach ($alumnosNuevo as $alumno) : ?>
                                        <tr>
                                            ...
                                            <td><?php echo $alumno['nombres']; ?></td>
                                            <td><?php echo $alumno['grado']; ?></td>
                                            <td><input type="checkbox" name="asistencia_<?php echo $alumno['id']; ?>" value="asistio"></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
