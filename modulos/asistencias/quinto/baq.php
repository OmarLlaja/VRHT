...
<div class="container-fluid">
    <div class="page-header">
        <h1 class="text-titles"><i class="zmdi zmdi-search zmdi-hc-fw"></i> RESULTADOS DE LA BÚSQUEDA: <small>5TO GRADO</small></h1>
    </div>
</div>
<div class="container-fluid">
    <div class="row">
        ...
        <?php foreach ($fechas as $fecha) { ?>
            <div class="text-right">
                        <a href="pdfQ.php?fecha=<?php echo $fecha; ?>" target="_blank" class="btn btn-success" style="border: 2px solid #808080; background-color: #808080; color: #fff;">
