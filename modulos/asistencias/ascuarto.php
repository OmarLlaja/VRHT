...
<div class="container-fluid">
    <div class="page-header">
        <h1 class="text-titles"><i class="zmdi zmdi-book zmdi-hc-fw"></i> Asistencias: <small>4TO GRADO</small></h1>
    </div>
</div>
<div class="container-fluid">
    <div class="row">
            ...
            <div id="myTabContent" class="tab-content">
                <div class="tab-pane fade active in" id="list">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <a href="cuarto/pdfC.php?fecha=<?php echo $fecha_busqueda; ?>" target="_blank" class="btn btn-success" style="border: 2px solid #808080; background-color: #808080; color: #fff;">
                ...
                <div class="tab-pane fade" id="new">
                    <div class="table-responsive">
                        ...
                        <form action="gac.php" method="POST">
