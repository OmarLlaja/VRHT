...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(100, 10, utf8_decode("REPORTE DE HORARIOS PRIMER GRADO "), 0, 1, 'C', 0);
      $this->Ln(7);
      ...
      $this->Cell(45, 10, utf8_decode('LUNES'), 1, 0, 'C', 1);
      $this->Cell(45, 10, utf8_decode('MARTES'), 1, 0, 'C', 1);
      $this->Cell(45, 10, utf8_decode('MIERCOLES'), 1, 0, 'C', 1);
      $this->Cell(45, 10, utf8_decode('JUEVES'), 1, 0, 'C', 1);
      $this->Cell(45, 10, utf8_decode('VIERNES'), 1, 1, 'C', 1);
   }
...
FROM horario
WHERE id_grado='1' AND anio = $año_busqueda
...
while ($datos_reporte = $resultado->fetch(PDO::FETCH_OBJ)) {
   ...
   $pdf->Cell(45, 10, utf8_decode($datos_reporte->lunes), 1, 0, 'C', 1);
   $pdf->Cell(45, 10, utf8_decode($datos_reporte->martes), 1, 0, 'C', 1);
   $pdf->Cell(45, 10, utf8_decode($datos_reporte->miercoles), 1, 0, 'C', 1);
   $pdf->Cell(45, 10, utf8_decode($datos_reporte->jueves), 1, 0, 'C', 1);
   $pdf->Cell(45, 10, utf8_decode($datos_reporte->viernes), 1, 1, 'C', 1);
}
