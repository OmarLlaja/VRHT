...
<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-book zmdi-hc-fw"></i> HORARIOS: <small>SEGUNDO</small></h1>
			</div>
		</div>
		<div class="container-fluid">
			<div class="row">
					  	...
					  	<div class="tab-pane fade active in" id="list">
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right">
                                    <a href="pdfSegundo.php?año_busqueda=<?php echo $año_busqueda; ?>" target="_blank" class="btn btn-success" style="border: 2px solid #808080; background-color: #808080; color: #fff;">
							...
							<div class="table-responsive">
								<table class="table table-hover text-center">
                                    ...
                                    FROM horario
                                    WHERE id_grado='3' AND anio = $año_busqueda
                                    ...
                                    if ($result->rowCount() > 0) {
                                        ...
                                        while($row = $result->fetch(PDO::FETCH_ASSOC)) {
                                            ...
                                            echo "<td>
                                                        <a href='ehs.php?id=" . $row["id"] . "' class='edit-btn'>Editar</a> 
                                                        <a href='hsegundo.php?id=" . $row["id"] . "' class='delete-btn'>Eliminar</a>
                                                 </td>";
                                            echo "</tr>";
                                        }
                                    } else {
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-xs-12 col-md-10 col-md-offset-1">
                                        <form action="ghs.php" method="POST">
