                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-xs-12 col-md-10 col-md-offset-1">
                                    <form action="ehq.php?id=<?php echo $registro['id']; ?>" method="POST">
                                        ...
                                        <p class="text-center">
                                        <a href="hquinto.php" class="btn btn-danger btn-raised btn-xs"><i class="zmdi zmdi-close"></i> CERRAR</a>
