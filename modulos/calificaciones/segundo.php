...
WHERE  id_grado = '3' AND n.anio = $año_busqueda");
...
INNER JOIN profesores p ON n.id_profesor = p.id
INNER JOIN grados g ON n.id_grado = g.id
WHERE c.id = '1' and g.id = '3' AND n.anio = $año_busqueda");
$stm->execute(); // Ejecutar la consulta preparada
...
INNER JOIN profesores p ON n.id_profesor = p.id
INNER JOIN grados g ON n.id_grado = g.id
WHERE c.id = '2' and g.id = '3' AND n.anio = $año_busqueda");
$stm->execute(); // Ejecutar la consulta preparada
...
INNER JOIN profesores p ON n.id_profesor = p.id
INNER JOIN grados g ON n.id_grado = g.id
WHERE c.id = '3' and g.id = '3' AND n.anio = $año_busqueda");
$stm->execute(); // Ejecutar la consulta preparada
...
INNER JOIN profesores p ON n.id_profesor = p.id
INNER JOIN grados g ON n.id_grado = g.id
WHERE c.id = '8' and g.id = '3' AND n.anio = $año_busqueda");
$stm->execute(); // Ejecutar la consulta preparada
...
INNER JOIN profesores p ON n.id_profesor = p.id
INNER JOIN grados g ON n.id_grado = g.id
WHERE c.id = '9' and g.id = '3' AND n.anio = $año_busqueda");
$stm->execute(); // Ejecutar la consulta preparada
...
INNER JOIN profesores p ON n.id_profesor = p.id
INNER JOIN grados g ON n.id_grado = g.id
WHERE c.id = '10' and g.id = '3' AND n.anio = $año_busqueda");
$stm->execute(); // Ejecutar la consulta preparada
...
INNER JOIN profesores p ON n.id_profesor = p.id
INNER JOIN grados g ON n.id_grado = g.id
WHERE c.id = '11' and g.id = '3' AND n.anio = $año_busqueda");
$stm->execute(); // Ejecutar la consulta preparada
...
INNER JOIN profesores p ON n.id_profesor = p.id
INNER JOIN grados g ON n.id_grado = g.id
WHERE c.id = '12' and g.id = '3' AND n.anio = $año_busqueda");
$stm->execute(); // Ejecutar la consulta preparada
...
INNER JOIN profesores p ON n.id_profesor = p.id
INNER JOIN grados g ON n.id_grado = g.id
WHERE c.id = '13' and g.id = '3' AND n.anio = $año_busqueda");
$stm->execute(); // Ejecutar la consulta preparada
...
INNER JOIN profesores p ON n.id_profesor = p.id
INNER JOIN grados g ON n.id_grado = g.id
WHERE c.id = '14' and g.id = '3' AND n.anio = $año_busqueda");
$stm->execute(); // Ejecutar la consulta preparada
...
if ($_POST) {
    ...
    if($result['total'] > 0) {
		...
		echo "<script>window.location.href = 'segundo.php';</script>";
		return;
        }else {
                            ...
                            <div class="table-responsive">
								<div class="row">
									...
									<div class="col-md-6 text-right">
										<a href="segundo/pdfSTd.php?año_busqueda=<?php echo $año_busqueda; ?>" target="_blank" class="btn btn-success custom-button" style="background-color: #808080; color: #fff;">
                                ...
                                <table class="table table-hover text-center">                              
                                    ...
                                    <?php foreach($colegionacional as $colegio)     {  ?>
                                        ...
                                        <td>
                                            <a href="eds.php?id=<?php  echo $colegio['id']; ?>" class="btn btn-success btn-raised btn-xs">Editar</a>
                                        </td>
                                        <td>
                                            <a href="segundo.php?id=<?php  echo $colegio['id']; ?>" class="btn btn-danger btn-raised btn-xs">Elimninar</a>
                                        </td>
                                        </tr>
                                    <?php }  ?>		
                                    </tbody>
										...
										<form action="" method="POST" >
                                                ...
                                                <div class="form-group">
													...
													<select class="form-control" name="grado" required>
														...
														$query = "SELECT id, nombre_grado FROM grados WHERE id = 3" ;
														$stmt = $conexion->prepare($query);
														$stmt->execute();
														$alumnos = $stmt->fetchAll(PDO::FETCH_ASSOC);
					  	...
					  	<div class="tab-pane fade" id="dp">
                            ...
                            <div class="table-responsive">
								<div class="row">
									...
									<div class="col-md-6 text-right">
										<a href="segundo/pdfSDp.php?año_busqueda=<?php echo $año_busqueda; ?>" target="_blank" class="btn btn-success custom-button" style="background-color: #808080; color: #fff;">
											<i class="fas fa-file-pdf"></i> Exportar a PDF
										</a>
									</div>
								</div>
                                <table class="table table-hover text-center">
                                    ...
                                    <?php foreach($cdp as $colegio)     {  ?>
                                        ...
                                        <td>
                                            <a href="segundo.php?id=<?php  echo $colegio['id']; ?>" class="btn btn-danger btn-raised btn-xs">ELIMINAR</a>
                                        </td>
                                        </tr>
                                    <?php }  ?>		
                                    </tbody>
					  	...
					  	<div class="tab-pane fade" id="cc">
                            ...
                            <div class="table-responsive">
								<div class="row">
									...
									<div class="col-md-6 text-right">
										<a href="segundo/pdfSCc.php?año_busqueda=<?php echo $año_busqueda; ?>" target="_blank" class="btn btn-success custom-button" style="background-color: #808080; color: #fff;">
											<i class="fas fa-file-pdf"></i> Exportar a PDF
										</a>
									</div>
								</div>
					  	...
					  	<div class="tab-pane fade" id="ac">
                            ...
                            <div class="table-responsive">
								<div class="row">
									...
									<div class="col-md-6 text-right">
										<a href="segundo/pdfSAc.php?año_busqueda=<?php echo $año_busqueda; ?>" target="_blank" class="btn btn-success custom-button" style="background-color: #808080; color: #fff;">
											<i class="fas fa-file-pdf"></i> Exportar a PDF
										</a>
									</div>
								</div>
                        ...
                        <div class="tab-pane fade" id="cs">
                            ...
                            <div class="table-responsive">
								<div class="row">
									...
									<div class="col-md-6 text-right">
										<a href="segundo/pdfSCs.php?año_busqueda=<?php echo $año_busqueda; ?>" target="_blank" class="btn btn-success custom-button" style="background-color: #808080; color: #fff;">
											<i class="fas fa-file-pdf"></i> Exportar a PDF
										</a>
									</div>
								</div>
                        ...
                        <div class="tab-pane fade" id="co">
                            ...
                            <div class="table-responsive">
								<div class="row">
									...
									<div class="col-md-6 text-right">
										<a href="segundo/pdfSCo.php?año_busqueda=<?php echo $año_busqueda; ?>" target="_blank" class="btn btn-success custom-button" style="background-color: #808080; color: #fff;">
											<i class="fas fa-file-pdf"></i> Exportar a PDF
										</a>
									</div>
								</div>
                        ...
                        <div class="tab-pane fade" id="in">
                            ...
                            <div class="table-responsive">
								<div class="row">
									...
									<div class="col-md-6 text-right">
										<a href="segundo/pdfSIn.php?año_busqueda=<?php echo $año_busqueda; ?>" target="_blank" class="btn btn-success custom-button" style="background-color: #808080; color: #fff;">
											<i class="fas fa-file-pdf"></i> Exportar a PDF
										</a>
									</div>
								</div>
					  	...
					  	<div class="tab-pane fade" id="ct">
                            ...
                            <div class="table-responsive">
								<div class="row">
									...
									<div class="col-md-6 text-right">
										<a href="segundo/pdfSCt.php?año_busqueda=<?php echo $año_busqueda; ?>" target="_blank" class="btn btn-success custom-button" style="background-color: #808080; color: #fff;">
											<i class="fas fa-file-pdf"></i> Exportar a PDF
										</a>
									</div>
								</div>
                        ...
                        <div class="tab-pane fade" id="ef">
                            ...
                            <div class="table-responsive">
								<div class="row">
									...
									<div class="col-md-6 text-right">
										<a href="segundo/pdfSEf.php?año_busqueda=<?php echo $año_busqueda; ?>" target="_blank" class="btn btn-success custom-button" style="background-color: #808080; color: #fff;">
											<i class="fas fa-file-pdf"></i> Exportar a PDF
										</a>
									</div>
								</div>
                        ...
                        <div class="tab-pane fade" id="et">
                            ...
                            <div class="table-responsive">
								<div class="row">
									...
									<div class="col-md-6 text-right">
										<a href="segundo/pdfSEt.php?año_busqueda=<?php echo $año_busqueda; ?>" target="_blank" class="btn btn-success custom-button" style="background-color: #808080; color: #fff;">
											<i class="fas fa-file-pdf"></i> Exportar a PDF
										</a>
									</div>
								</div>
                        ...
                        <div class="tab-pane fade" id="er">
                            ...
                            <div class="table-responsive">
								<div class="row">
									...
									<div class="col-md-6 text-right">
										<a href="segundo/pdfSEr.php?año_busqueda=<?php echo $año_busqueda; ?>" target="_blank" class="btn btn-success custom-button" style="background-color: #808080; color: #fff;">
											<i class="fas fa-file-pdf"></i> Exportar a PDF
										</a>
									</div>
								</div>
                        ...
                        <div class="tab-pane fade" id="ma">
                            ...
                            <div class="table-responsive">
								<div class="row">
									...
									<div class="col-md-6 text-right">
										<a href="segundo/pdfSMa.php?año_busqueda=<?php echo $año_busqueda; ?>" target="_blank" class="btn btn-success custom-button" style="background-color: #808080; color: #fff;">
											<i class="fas fa-file-pdf"></i> Exportar a PDF
										</a>
									</div>
								</div>
