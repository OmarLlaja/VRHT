...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(100, 10, utf8_decode("NOTAS- 1ER GRADO MATEMATICAS "), 0, 1, 'C', 0);
      $this->Ln(7);
      ...
      $this->Cell(20, 10, utf8_decode('PERIODO'), 1, 0, 'C', 1);
      $this->Cell(20, 10, utf8_decode('ALUMNO'), 1, 0, 'C', 1);
...
$pdf = new PDF();
$pdf->AddPage('L'); /* aqui entran dos para parametros (orientación, tamaño) P->portrait L->landscape tamaño (A3.A4.A5.letter.legal) */
...
// Obtener el año de búsqueda de la URL
$año_busqueda = $_GET['año_busqueda'];
...
while ($datos_reporte = $resultado->fetch(PDO::FETCH_OBJ)) {
   ...
   $pdf->Cell(20, 10, utf8_decode($datos_reporte->Periodo), 1, 0, 'C', 1);
   $pdf->Cell(20, 10, utf8_decode($datos_reporte->Alumno), 1, 0, 'C', 1);
