...
WHERE  id_grado = '6' AND n.anio = $año_busqueda");
...
INNER JOIN profesores p ON n.id_profesor = p.id
INNER JOIN grados g ON n.id_grado = g.id
WHERE c.id = '1' and g.id = '6' AND n.anio = $año_busqueda");
$stm->execute(); // Ejecutar la consulta preparada
...
INNER JOIN profesores p ON n.id_profesor = p.id
INNER JOIN grados g ON n.id_grado = g.id
WHERE c.id = '2' and g.id = '6' AND n.anio = $año_busqueda");
$stm->execute(); // Ejecutar la consulta preparada
...
INNER JOIN profesores p ON n.id_profesor = p.id
INNER JOIN grados g ON n.id_grado = g.id
WHERE c.id = '3' and g.id = '6' AND n.anio = $año_busqueda");
$stm->execute(); // Ejecutar la consulta preparada
...
INNER JOIN profesores p ON n.id_profesor = p.id
INNER JOIN grados g ON n.id_grado = g.id
WHERE c.id = '6' and g.id = '6' AND n.anio = $año_busqueda");
$stm->execute(); // Ejecutar la consulta preparada
...
INNER JOIN profesores p ON n.id_profesor = p.id
INNER JOIN grados g ON n.id_grado = g.id
WHERE c.id = '8' and g.id = '6' AND n.anio = $año_busqueda");
$stm->execute(); // Ejecutar la consulta preparada
...
INNER JOIN profesores p ON n.id_profesor = p.id
INNER JOIN grados g ON n.id_grado = g.id
WHERE c.id = '9' and g.id = '6' AND n.anio = $año_busqueda");
$stm->execute(); // Ejecutar la consulta preparada
...
INNER JOIN profesores p ON n.id_profesor = p.id
INNER JOIN grados g ON n.id_grado = g.id
WHERE c.id = '10' and g.id = '6' AND n.anio = $año_busqueda");
$stm->execute(); // Ejecutar la consulta preparada
...
INNER JOIN profesores p ON n.id_profesor = p.id
INNER JOIN grados g ON n.id_grado = g.id
WHERE c.id = '12' and g.id = '6' AND n.anio = $año_busqueda");
$stm->execute(); // Ejecutar la consulta preparada
...
INNER JOIN profesores p ON n.id_profesor = p.id
INNER JOIN grados g ON n.id_grado = g.id
WHERE c.id = '13' and g.id = '6' AND n.anio = $año_busqueda");
$stm->execute(); // Ejecutar la consulta preparada
...
INNER JOIN profesores p ON n.id_profesor = p.id
INNER JOIN grados g ON n.id_grado = g.id
WHERE c.id = '14' and g.id = '6' AND n.anio = $año_busqueda");
$stm->execute(); // Ejecutar la consulta preparada
...
if ($_POST) {
    ...
    if($result['total'] > 0) {
		...
		echo "<script>window.location.href = 'quinto.php';</script>";
		return;
        }else {
                            ...
                            <div class="table-responsive">
								<div class="row">
									...
									<div class="col-md-6 text-right">
										<a href="quinto/pdfQTd.php?año_busqueda=<?php echo $año_busqueda; ?>" target="_blank" class="btn btn-success custom-button" style="background-color: #808080; color: #fff;">
                                ...
                                <table class="table table-hover text-center">                              
                                    ...
                                    <?php foreach($colegionacional as $colegio)     {  ?>
                                        ...
                                        <td>
                                            <a href="edq.php?id=<?php  echo $colegio['id']; ?>" class="btn btn-success btn-raised btn-xs">Editar</a>
                                        </td>
                                        <td>
                                            <a href="quinto.php?id=<?php  echo $colegio['id']; ?>" class="btn btn-danger btn-raised btn-xs">Elimninar</a>
                                        </td>
                                        </tr>
                                    <?php }  ?>		
                                    </tbody>
					  	...
					  	<div class="tab-pane fade" id="dp">
                            ...
                            <div class="table-responsive">
								<div class="row">
									...
									<div class="col-md-6 text-right">
										<a href="quinto/pdfQDp.php?año_busqueda=<?php echo $año_busqueda; ?>" target="_blank" class="btn btn-success custom-button" style="background-color: #808080; color: #fff;">
											<i class="fas fa-file-pdf"></i> Exportar a PDF
										</a>
									</div>
								</div>
                                <table class="table table-hover text-center">
                                    ...
                                    <?php foreach($cdp as $colegio)     {  ?>
                                        ...
                                        <td>
                                            <a href="quinto.php?id=<?php  echo $colegio['id']; ?>" class="btn btn-danger btn-raised btn-xs">ELIMINAR</a>
                                        </td>
                                        </tr>
                                    <?php }  ?>		
                                    </tbody>
					  	...
					  	<div class="tab-pane fade" id="cc">
                            ...
                            <div class="table-responsive">
								<div class="row">
									...
									<div class="col-md-6 text-right">
										<a href="quinto/pdfQCc.php?año_busqueda=<?php echo $año_busqueda; ?>" target="_blank" class="btn btn-success custom-button" style="background-color: #808080; color: #fff;">
											<i class="fas fa-file-pdf"></i> Exportar a PDF
										</a>
									</div>
								</div>
					  	...
					  	<div class="tab-pane fade" id="ac">
                            ...
                            <div class="table-responsive">
								<div class="row">
									...
									<div class="col-md-6 text-right">
										<a href="quinto/pdfQAc.php?año_busqueda=<?php echo $año_busqueda; ?>" target="_blank" class="btn btn-success custom-button" style="background-color: #808080; color: #fff;">
											<i class="fas fa-file-pdf"></i> Exportar a PDF
										</a>
									</div>
								</div>
                        ...
                        <div class="tab-pane fade" id="cs">
                            ...
                            <div class="table-responsive">
								<div class="row">
									...
									<div class="col-md-6 text-right">
										<a href="quinto/pdfQCs.php?año_busqueda=<?php echo $año_busqueda; ?>" target="_blank" class="btn btn-success custom-button" style="background-color: #808080; color: #fff;">
											<i class="fas fa-file-pdf"></i> Exportar a PDF
										</a>
									</div>
								</div>
                        ...
                        <div class="tab-pane fade" id="co">
                            ...
                            <div class="table-responsive">
								<div class="row">
									...
									<div class="col-md-6 text-right">
										<a href="quinto/pdfQCo.php?año_busqueda=<?php echo $año_busqueda; ?>" target="_blank" class="btn btn-success custom-button" style="background-color: #808080; color: #fff;">
											<i class="fas fa-file-pdf"></i> Exportar a PDF
										</a>
									</div>
								</div>
                        ...
                        <div class="tab-pane fade" id="in">
                            ...
                            <div class="table-responsive">
								<div class="row">
									...
									<div class="col-md-6 text-right">
										<a href="quinto/pdfQIn.php?año_busqueda=<?php echo $año_busqueda; ?>" target="_blank" class="btn btn-success custom-button" style="background-color: #808080; color: #fff;">
											<i class="fas fa-file-pdf"></i> Exportar a PDF
										</a>
									</div>
								</div>
					  	...
					  	<div class="tab-pane fade" id="ct">
                            ...
                            <div class="table-responsive">
								<div class="row">
									...
									<div class="col-md-6 text-right">
										<a href="quinto/pdfQCt.php?año_busqueda=<?php echo $año_busqueda; ?>" target="_blank" class="btn btn-success custom-button" style="background-color: #808080; color: #fff;">
											<i class="fas fa-file-pdf"></i> Exportar a PDF
										</a>
									</div>
								</div>
                        ...
                        <div class="tab-pane fade" id="ef">
                            ...
                            <div class="table-responsive">
								<div class="row">
									...
									<div class="col-md-6 text-right">
										<a href="quinto/pdfQEf.php?año_busqueda=<?php echo $año_busqueda; ?>" target="_blank" class="btn btn-success custom-button" style="background-color: #808080; color: #fff;">
											<i class="fas fa-file-pdf"></i> Exportar a PDF
										</a>
									</div>
								</div>
                        ...
                        <div class="tab-pane fade" id="et">
                            ...
                            <div class="table-responsive">
								<div class="row">
									...
									<div class="col-md-6 text-right">
										<a href="quinto/pdfQEt.php?año_busqueda=<?php echo $año_busqueda; ?>" target="_blank" class="btn btn-success custom-button" style="background-color: #808080; color: #fff;">
											<i class="fas fa-file-pdf"></i> Exportar a PDF
										</a>
									</div>
								</div>
                        ...
                        <div class="tab-pane fade" id="er">
                            ...
                            <div class="table-responsive">
								<div class="row">
									...
									<div class="col-md-6 text-right">
										<a href="quinto/pdfQEr.php?año_busqueda=<?php echo $año_busqueda; ?>" target="_blank" class="btn btn-success custom-button" style="background-color: #808080; color: #fff;">
											<i class="fas fa-file-pdf"></i> Exportar a PDF
										</a>
									</div>
								</div>
                        ...
                        <div class="tab-pane fade" id="ma">
                            ...
                            <div class="table-responsive">
								<div class="row">
									...
									<div class="col-md-6 text-right">
										<a href="quinto/pdfQMa.php?año_busqueda=<?php echo $año_busqueda; ?>" target="_blank" class="btn btn-success custom-button" style="background-color: #808080; color: #fff;">
											<i class="fas fa-file-pdf"></i> Exportar a PDF
										</a>
									</div>
								</div>
