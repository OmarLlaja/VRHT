...
WHERE  id_grado = '1' AND n.anio = $año_busqueda");
...
INNER JOIN profesores p ON n.id_profesor = p.id
INNER JOIN grados g ON n.id_grado = g.id
WHERE c.id = '1' and g.id = '1' AND n.anio = $año_busqueda");
$stm->execute(); // Ejecutar la consulta preparada
...
INNER JOIN profesores p ON n.id_profesor = p.id
INNER JOIN grados g ON n.id_grado = g.id
WHERE c.id = '2' and g.id = '1' AND n.anio = $año_busqueda");
$stm->execute(); // Ejecutar la consulta preparada
...
INNER JOIN profesores p ON n.id_profesor = p.id
INNER JOIN grados g ON n.id_grado = g.id
WHERE c.id = '3' and g.id = '1' AND n.anio = $año_busqueda");
$stm->execute(); // Ejecutar la consulta preparada
...
INNER JOIN profesores p ON n.id_profesor = p.id
INNER JOIN grados g ON n.id_grado = g.id
WHERE c.id = '6' and g.id = '1' AND n.anio = $año_busqueda");
$stm->execute(); // Ejecutar la consulta preparada
...
INNER JOIN profesores p ON n.id_profesor = p.id
INNER JOIN grados g ON n.id_grado = g.id
WHERE c.id = '8' and g.id = '1' AND n.anio = $año_busqueda");
$stm->execute(); // Ejecutar la consulta preparada
...
INNER JOIN profesores p ON n.id_profesor = p.id
INNER JOIN grados g ON n.id_grado = g.id
WHERE c.id = '9' and g.id = '1' AND n.anio = $año_busqueda");
$stm->execute(); // Ejecutar la consulta preparada
...
INNER JOIN profesores p ON n.id_profesor = p.id
INNER JOIN grados g ON n.id_grado = g.id
WHERE c.id = '10' and g.id = '1' AND n.anio = $año_busqueda");
$stm->execute(); // Ejecutar la consulta preparada
...
INNER JOIN profesores p ON n.id_profesor = p.id
INNER JOIN grados g ON n.id_grado = g.id
WHERE c.id = '11' and g.id = '1' AND n.anio = $año_busqueda");
$stm->execute(); // Ejecutar la consulta preparada
...
INNER JOIN profesores p ON n.id_profesor = p.id
INNER JOIN grados g ON n.id_grado = g.id
WHERE c.id = '12' and g.id = '1' AND n.anio = $año_busqueda");
$stm->execute(); // Ejecutar la consulta preparada
...
INNER JOIN profesores p ON n.id_profesor = p.id
INNER JOIN grados g ON n.id_grado = g.id
WHERE c.id = '13' and g.id = '1' AND n.anio = $año_busqueda");
$stm->execute(); // Ejecutar la consulta preparada
...
INNER JOIN profesores p ON n.id_profesor = p.id
INNER JOIN grados g ON n.id_grado = g.id
WHERE c.id = '14' and g.id = '1' AND n.anio = $año_busqueda");
$stm->execute(); // Ejecutar la consulta preparada
...
if ($_POST) {
	...
	if ($result['total'] > 0) {
		...
		echo "<script>window.location.href = 'primero.php';</script>";
		return;
	} else {
					...
					<div class="table-responsive">
						<div class="row">
							...
							<div class="col-md-6 text-right">
								<a href="primero/pdfPTd.php?año_busqueda=<?php echo $año_busqueda; ?>" target="_blank" class="btn btn-success custom-button" style="background-color: #808080; color: #fff;">
							...
							<tbody>
								<?php foreach ($colegionacional as $colegio) {  ?>
									<tr>
										...
										<td>
											<a href="edp.php?id=<?php echo $colegio['id']; ?>" class="btn btn-success btn-raised btn-xs">Editar</a>
										</td>
										<td>
											<a href="primero.php?id=<?php echo $colegio['id']; ?>" class="btn btn-danger btn-raised btn-xs">Elimninar</a>
										</td>
									</tr>
								<?php }  ?>
							</tbody>
				...
				<div class="tab-pane fade" id="dp">
					...
					<div class="table-responsive">
						<div class="row">
							...
							<div class="col-md-6 text-right">
								<a href="primero/pdfPDp.php?año_busqueda=<?php echo $año_busqueda; ?>" target="_blank" class="btn btn-success custom-button" style="background-color: #808080; color: #fff;">
									<i class="fas fa-file-pdf"></i> Exportar a PDF
								</a>
							</div>
						</div>
							...
							<tbody>
								<?php foreach ($cdp as $colegio) {  ?>
									<tr>
										...
										<td>
											<a href="primero.php?id=<?php echo $colegio['id']; ?>" class="btn btn-danger btn-raised btn-xs">ELIMINAR</a>
										</td>
									</tr>
								<?php }  ?>
							</tbody>
				...
				<div class="tab-pane fade" id="cc">
					...
					<div class="table-responsive">
						<div class="row">
							...
							<div class="col-md-6 text-right">
								<a href="primero/pdfPCc.php?año_busqueda=<?php echo $año_busqueda; ?>" target="_blank" class="btn btn-success custom-button" style="background-color: #808080; color: #fff;">
									<i class="fas fa-file-pdf"></i> Exportar a PDF
								</a>
							</div>
						</div>
				...
				<div class="tab-pane fade" id="ac">
					...
					<div class="table-responsive">
						<div class="row">
							...
							<div class="col-md-6 text-right">
								<a href="primero/pdfPAc.php?año_busqueda=<?php echo $año_busqueda; ?>" target="_blank" class="btn btn-success custom-button" style="background-color: #808080; color: #fff;">
									<i class="fas fa-file-pdf"></i> Exportar a PDF
								</a>
							</div>
						</div>
				...
				<div class="tab-pane fade" id="cs">
					...
					<div class="table-responsive">
						<div class="row">
							...
							<div class="col-md-6 text-right">
								<a href="primero/pdfPCs.php?año_busqueda=<?php echo $año_busqueda; ?>" target="_blank" class="btn btn-success custom-button" style="background-color: #808080; color: #fff;">
									<i class="fas fa-file-pdf"></i> Exportar a PDF
								</a>
							</div>
						</div>
				...
				<div class="tab-pane fade" id="co">
					...
					<div class="table-responsive">
						<div class="row">
							...
							<div class="col-md-6 text-right">
								<a href="primero/pdfPCo.php?año_busqueda=<?php echo $año_busqueda; ?>" target="_blank" class="btn btn-success custom-button" style="background-color: #808080; color: #fff;">
									<i class="fas fa-file-pdf"></i> Exportar a PDF
								</a>
							</div>
						</div>
				...
				<div class="tab-pane fade" id="in">
					...
					<div class="table-responsive">
						<div class="row">
							...
							<div class="col-md-6 text-right">
								<a href="primero/pdfPIn.php?año_busqueda=<?php echo $año_busqueda; ?>" target="_blank" class="btn btn-success custom-button" style="background-color: #808080; color: #fff;">
									<i class="fas fa-file-pdf"></i> Exportar a PDF
								</a>
							</div>
						</div>
				...
				<div class="tab-pane fade" id="ct">
					...
					<div class="table-responsive">
						<div class="row">
							...
							<div class="col-md-6 text-right">
								<a href="primero/pdfPCt.php?año_busqueda=<?php echo $año_busqueda; ?>" target="_blank" class="btn btn-success custom-button" style="background-color: #808080; color: #fff;">
									<i class="fas fa-file-pdf"></i> Exportar a PDF
								</a>
							</div>
						</div>
				...
				<div class="tab-pane fade" id="ef">
					...
					<div class="table-responsive">
						<div class="row">
							...
							<div class="col-md-6 text-right">
								<a href="primero/pdfPEf.php?año_busqueda=<?php echo $año_busqueda; ?>" target="_blank" class="btn btn-success custom-button" style="background-color: #808080; color: #fff;">
									<i class="fas fa-file-pdf"></i> Exportar a PDF
								</a>
							</div>
						</div>
				...
				<div class="tab-pane fade" id="et">
					...
					<div class="table-responsive">
						<div class="row">
							...
							<div class="col-md-6 text-right">
								<a href="primero/pdfPEt.php?año_busqueda=<?php echo $año_busqueda; ?>" target="_blank" class="btn btn-success custom-button" style="background-color: #808080; color: #fff;">
									<i class="fas fa-file-pdf"></i> Exportar a PDF
								</a>
							</div>
						</div>
				...
				<div class="tab-pane fade" id="er">
					...
					<div class="table-responsive">
						<div class="row">
							...
							<div class="col-md-6 text-right">
								<a href="primero/pdfPEr.php?año_busqueda=<?php echo $año_busqueda; ?>" target="_blank" class="btn btn-success custom-button" style="background-color: #808080; color: #fff;">
									<i class="fas fa-file-pdf"></i> Exportar a PDF
								</a>
							</div>
						</div>
				...
				<div class="tab-pane fade" id="ma">
					...
					<div class="table-responsive">
						<div class="row">
							...
							<div class="col-md-6 text-right">
								<a href="primero/pdfPMa.php?año_busqueda=<?php echo $año_busqueda; ?>" target="_blank" class="btn btn-success custom-button" style="background-color: #808080; color: #fff;">
									<i class="fas fa-file-pdf"></i> Exportar a PDF
								</a>
							</div>
						</div>
