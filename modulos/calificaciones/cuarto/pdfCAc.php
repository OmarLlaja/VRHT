...
$resultado = $conexion->query("SELECT n.id,pe.anio AS Periodo,a.nombres AS Alumno,c.nombre_curso AS Curso,p.nombres Profesor,g.nombre_grado AS Grado, n.unidad1,n.unidad2,n.unidad3,n.promedio
FROM calificaciones n
INNer JOIN periodo pe ON n.id_periodo = pe.id
