...
$stm = $conexion->prepare("SELECT * FROM administradores");
...
if (isset($_GET['id'])) {
    ...
    $stm = $conexion->prepare("DELETE FROM administradores WHERE id=:txtid");
...
if ($_POST) {
	...
	$query = "SELECT COUNT(*) as total FROM administradores WHERE dni = ?";
    ...
    $stm=$conexion-> prepare("INSERT INTO administradores(id, nombres, apellidos, dni, fecha_nacimiento,
...
<?php include("../../template/header.php");  ?>
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-male-alt zmdi-hc-fw"></i> Usuarios <small>Administradores</small></h1>
			</div>
			<p class="lead">Gestionar Administradores</p>
		</div>
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
									...
									<div class="col-xs-12 col-md-10 col-md-offset-1">
									    <form action="">
											...
											<div class="form-group label-floating">
											  ...
											  <input class="form-control" type="text" name="apellidos" requerid>
											</div>
											<div class="form-group label-floating">
											  <label class="control-label">Dni</label>
											  <input class="form-control" type="text" name="dni" requerid>
											</div>
											<div class="form-group label-floating">
											  <label class="control-label">Fecha Nacimiento</label>
											  <input class="form-control" type="date" name="nacimiento" requerid>
											</div>
											<div class="form-group label-floating">
											  <label class="control-label">Direccion</label>
											  <input class="form-control" type="text" name="direccion" requerid>
											</div>
											<div class="form-group label-floating">
											  <label class="control-label">Telefono</label>
											  <input class="form-control" type="text" name="telefono" requerid>
											</div>
											<div class="form-group">
											  <label class="control-label">Email</label>
											  <input class="form-control" type="email" name="correo" requerid>
											</div>											
